...
public final class ParsedSentenceOnly implements ParsedSentence {
    ...
    public ParsedSentenceOnly(Object[] inputRow, Sentence sentence, boolean ignoreCase) {
        ...
        this.positiveMathTerms = emptyList();
