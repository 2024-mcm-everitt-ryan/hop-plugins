...
public class SentenceBiasDetectorData extends BaseTransformData implements ITransformData {
    public int indexOfTaxonomyField;
    public int indexOfSubjectivityField;
    ...
    public SentenceBiasDetectorData() {
        super();
        indexOfTaxonomyField = -1;
        indexOfSubjectivityField = -1;
