...
@Transform(
        ...
        documentationUrl = "/pipeline/transforms/stanford-simple-nlp.html")
public class StanfordSimpleNlpMeta extends BaseTransformMeta<StanfordSimpleNlp, StanfordSimpleNlpData> {
    ...
    public void loadXml(Node transformNode, IHopMetadataProvider metadataProvider)
        ...
        try {
            ...
            includePartOfSpeech = equalsIgnoreCase("Y", getTagValue(transformNode, "includePartOfSpeech"));
            ...
            throw new HopXmlException(
                    BaseMessages.getString(PKG, "StanfordSimpleNlpMeta.Exception.UnableToReadTransformMeta"), e);
        }
    }
