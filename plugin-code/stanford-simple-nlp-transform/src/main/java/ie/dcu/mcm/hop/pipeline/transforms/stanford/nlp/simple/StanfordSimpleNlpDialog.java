...
public class StanfordSimpleNlpDialog extends BaseTransformDialog implements ITransformDialog {
    ...
    public String open() {
        ...
        wlOutputFieldNamePrefix.setText(getString(PKG, "StanfordSimpleNlpDialog.OutputFieldNamePrefix.Label"));
        ...
        wlIncludePartOfSpeech.setText(getString(PKG, "StanfordSimpleNlpDialog.IncludePartOfSpeech.Label"));
        ...
        wIncludePartOfSpeech.setToolTipText(getString(PKG, "StanfordSimpleNlpDialog.IncludePartOfSpeech.Tooltip"));
