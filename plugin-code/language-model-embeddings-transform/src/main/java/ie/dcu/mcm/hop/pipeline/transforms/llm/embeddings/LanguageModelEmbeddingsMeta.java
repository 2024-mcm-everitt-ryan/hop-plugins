...
import static ie.dcu.mcm.hop.pipeline.transforms.llm.embeddings.LanguageModelEmbeddingsMeta.ContextMeasurementType.WORD;
...
@Transform(
        id = "LanguageModelEmbeddings",
        image = "language-model-embeddings.svg",
        name = "i18n::BaseTransform.TypeLongDesc.LanguageModelEmbeddings",
        description = "i18n::BaseTransform.TypeTooltipDesc.LanguageModelEmbeddings",
        categoryDescription =
                "i18n:org.apache.hop.pipeline.transform:BaseTransform.Category.Transform",
        documentationUrl = "/pipeline/transforms/language-model-embeddings.html")
public class LanguageModelEmbeddingsMeta extends BaseTransformMeta<LanguageModelEmbeddings, LanguageModelEmbeddingsData> {
    private static final Class<?> PKG = LanguageModelEmbeddingsMeta.class; // For Translator
    ...
    public LanguageModelEmbeddingsMeta() {
        super();
    }
    ...
    public void loadXml(Node transformNode, IHopMetadataProvider metadataProvider)
        ...
        try {
            ...
            throw new HopXmlException(
                    getString(PKG, "LanguageModelEmbeddingsMeta.Exception.UnableToReadTransformMeta"), e);
        }
    }
    ...
    public void check(
        ...
        if (isEmpty(corpusField)) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_ERROR,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.CorpusFieldMissing"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
                            TYPE_RESULT_OK,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.CorpusFieldOK"),
                            transformMeta);
        }
        remarks.add(cr);
        ...
        if (isEmpty(taxonomyField)) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_ERROR,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.TaxonomyFieldMissing"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
                            TYPE_RESULT_OK,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.TaxonomyFieldOK"),
                            transformMeta);
        }
        remarks.add(cr);
        ...
        if (isEmpty(documentPartitionField)) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_ERROR,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.DocumentPartitionFieldMissing"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
                            TYPE_RESULT_OK,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.DocumentPartitionFieldOK"),
                            transformMeta);
        }
        remarks.add(cr);
        ...
        if (rightContextMaxSize < rightContextTargetSize || rightContextTargetSize <= 0) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_ERROR,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.RightContextInvalidNumber"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
                            TYPE_RESULT_OK,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.RightContextOK"),
                            transformMeta);
        }
        remarks.add(cr);
        ...
        if (leftContextMaxSize < leftContextTargetSize || leftContextTargetSize <= 0) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_ERROR,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.LeftContextInvalidNumber"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
                            TYPE_RESULT_OK,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.LeftContextOK"),
                            transformMeta);
        }
        remarks.add(cr);
        ...
        if (input.length > 0) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_OK,
                            getString(
                                    PKG, "LanguageModelEmbeddingsMeta.CheckResult.ReceivingInfoFromOtherTransforms"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
                            TYPE_RESULT_ERROR,
                            getString(PKG, "LanguageModelEmbeddingsMeta.CheckResult.NoInpuReceived"),
                            transformMeta);
        }
        remarks.add(cr);
    ...
    public enum ContextMeasurementType {
        ...
        WORD("WORD", getString(PKG, "LanguageModelEmbeddingsDialog.ContextMeasurementType.WORD")),
        CHARACTER("CHARACTER", getString(PKG, "LanguageModelEmbeddingsDialog.ContextMeasurementType.CHARACTER")),
        SENTENCE("SENTENCE", getString(PKG, "LanguageModelEmbeddingsDialog.ContextMeasurementType.SENTENCE"));
