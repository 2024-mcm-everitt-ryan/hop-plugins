...
import static ie.dcu.mcm.hop.pipeline.transforms.llm.embeddings.LanguageModelEmbeddingsMeta.ContextMeasurementType.getTypeFromDescription;
...
public class LanguageModelEmbeddingsDialog extends BaseTransformDialog implements ITransformDialog {
    private static final Class<?> PKG = LanguageModelEmbeddingsDialog.class; // For Translator
    private final LanguageModelEmbeddingsMeta input;
    ...
    public LanguageModelEmbeddingsDialog(
            Shell parent, IVariables variables, Object in, PipelineMeta pipelineMeta, String sname) {
        super(parent, variables, (BaseTransformMeta) in, pipelineMeta, sname);
        input = (LanguageModelEmbeddingsMeta) in;
    }
    ...
    public String open() {
        ...
        shell.setText(getString(PKG, "LanguageModelEmbeddingsDialog.Shell.Title"));
        ...
        wlTransformName.setText(getString(PKG, "LanguageModelEmbeddingsDialog.TransformName.Label"));
        ...
        wlCorpusFieldName.setText(getString(PKG, "LanguageModelEmbeddingsDialog.CorpusFieldName.Label"));
        ...
        wlTaxonomyFieldName.setText(getString(PKG, "LanguageModelEmbeddingsDialog.TaxonomyFieldName.Label"));
        ...
        wlDocumentPartitionFieldName.setText(getString(PKG, "LanguageModelEmbeddingsDialog.DocumentPartitionFieldName.Label"));
        ...
        wlContextMeasurement.setText(getString(PKG, "LanguageModelEmbeddingsDialog.ContextMeasurement.Label"));
        ...
        wlLeftContextTargetSize.setText(getString(PKG, "LanguageModelEmbeddingsDialog.LeftContextTargetSize.Label"));
        ...
        wlRightContextTargetSize.setText(getString(PKG, "LanguageModelEmbeddingsDialog.RightContextTargetSize.Label"));
        ...
        wlLeftContextMaxSize.setText(getString(PKG, "LanguageModelEmbeddingsDialog.LeftContextMaxSize.Label"));
        ...
        wlRightContextMaxSize.setText(getString(PKG, "LanguageModelEmbeddingsDialog.RightContextMaxSize.Label"));
        ...
        wlIgnoreCase.setText(getString(PKG, "LanguageModelEmbeddingsDialog.IgnoreCase.Label"));
        ...
        wIgnoreCase.setToolTipText(getString(PKG, "LanguageModelEmbeddingsDialog.IgnoreCase.Tooltip"));
    ...
    private void get() {
        if (!gotPreviousFields) {
            try {
                ...
                new ErrorDialog(
                        shell,
                        getString(PKG, "LanguageModelEmbeddingsDialog.FailedToGetFields.DialogTitle"),
                        getString(PKG, "LanguageModelEmbeddingsDialog.FailedToGetFields.DialogMessage"),
                        ke);
            }
        }
    }
