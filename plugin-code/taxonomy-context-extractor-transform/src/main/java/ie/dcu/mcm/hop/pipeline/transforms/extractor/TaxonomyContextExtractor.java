...
import ie.dcu.mcm.hop.pipeline.transforms.extractor.internals.*;
...
import static ie.dcu.mcm.hop.pipeline.transforms.extractor.internals.ParsedSentence.Builder.parsedSentenceBuilder;
...
public class TaxonomyContextExtractor extends BaseTransform<TaxonomyContextExtractorMeta, TaxonomyContextExtractorData> {
    public static final int OVER_ALLOCATE_SIZE = 10;
    private static final Class<?> PKG = TaxonomyContextExtractor.class; // For Translator
    ...
    public TaxonomyContextExtractor(
            TransformMeta transformMeta,
            TaxonomyContextExtractorMeta meta,
            TaxonomyContextExtractorData data,
            int copyNr,
    ...
    public boolean processRow() throws HopException {
        ...
        if (first) {
            ...
            if (isEmpty(meta.getCorpusField())) {
                throw new HopException(
                        BaseMessages.getString(PKG, "TaxonomyContextExtractor.Error.CorpusFieldMissing"));
            }
            if (isEmpty(meta.getTaxonomyField())) {
                throw new HopException(
                        BaseMessages.getString(PKG, "TaxonomyContextExtractor.Error.TaxonomyFieldMissing"));
            }
            if (isEmpty(meta.getDocumentPartitionField())) {
                throw new HopException(
                        BaseMessages.getString(PKG, "TaxonomyContextExtractor.Error.DocumentPartitionFieldMissing"));
            }
            ...
            try {
                ...
                if (troot.isEmpty()) {
                    throw new HopException(
                            BaseMessages.getString(PKG, "TaxonomyContextExtractor.Error.TaxonomyFieldInvalidJson"));
                }
                ...
                throw new HopException(
                        BaseMessages.getString(PKG, "TaxonomyContextExtractor.Error.TaxonomyFieldInvalidJson"), e);
            }
        ...
        try {
            if (log.isRowLevel()) {
                logRowlevel(
                        BaseMessages.getString(
                                PKG,
                                "TaxonomyContextExtractor.LineNumber",
            ...
            if (getTransformMeta().isDoingErrorHandling()) {
                ...
                logError(
                        BaseMessages.getString(PKG, "TaxonomyContextExtractor.ErrorInTransformRunning") + e.getMessage());
                setErrors(1);
                stopAll();
            ...
            if (sendToErrorRow) {
                ...
                putError(
                        getInputRowMeta(), r, 1, errorMessage, meta.getCorpusField(), "TaxonomyContextExtractor001");
            }
        }
    ...
    private void cacheIndexPositions() throws HopException {
        if (data.indexOfCorpusField < 0) {
            ...
            if (data.indexOfCorpusField < 0) {
                ...
                throw new HopException(
                        BaseMessages.getString(
                                PKG, "TaxonomyContextExtractor.Exception.CouldnotFindField", meta.getCorpusField()));
            }
        }
        if (data.indexOfTaxonomyField < 0) {
            ...
            if (data.indexOfTaxonomyField < 0) {
                ...
                throw new HopException(
                        BaseMessages.getString(
                                PKG, "TaxonomyContextExtractor.Exception.CouldnotFindField", meta.getTaxonomyField()));
            }
        }
        if (data.indexOfDocumentPartitionField < 0) {
            ...
            if (data.indexOfDocumentPartitionField < 0) {
                ...
                throw new HopException(
                        BaseMessages.getString(
                                PKG, "TaxonomyContextExtractor.Exception.CouldnotFindField", meta.getDocumentPartitionField()));
            }
        }
        ...
        for (String field : data.contextFields) {
            if (data.indexOfMap.getOrDefault(field, -1) < 0) {
                ...
                if (data.indexOfMap.getOrDefault(field, -1) < 0) {
                    ...
                    throw new HopException(
                            BaseMessages.getString(
                                    PKG, "TaxonomyContextExtractor.Exception.CouldnotFindField", field));
                }
            }
        }
    }
