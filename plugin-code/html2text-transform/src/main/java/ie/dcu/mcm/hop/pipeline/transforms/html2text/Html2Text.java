...
public class Html2Text extends BaseTransform<Html2TextMeta, Html2TextData> {
    ...
    public boolean processRow() throws HopException {
        ...
        if (first) {
            ...
            if (isEmpty(meta.getHtmlField())) {
                throw new HopException(
                        BaseMessages.getString(PKG, "Html2Text.Error.HtmlFieldMissing"));
            }
            if (isEmpty(meta.getOutputField())) {
                throw new HopException(
                        BaseMessages.getString(PKG, "Html2Text.Error.OutputFieldMissing"));
            }
        ...
        try {
            ...
            if (getTransformMeta().isDoingErrorHandling()) {
                ...
                logError(
                        BaseMessages.getString(PKG, "Html2Text.ErrorInTransformRunning") + e.getMessage());
                setErrors(1);
                stopAll();
            ...
            if (sendToErrorRow) {
                ...
                putError(
                        getInputRowMeta(), r, 1, errorMessage, meta.getHtmlField(), "Html2Text001");
            }
        }
    ...
    private void processSync(String html, Object[] inputRow) throws HopTransformException {
        ...
        if (meta.isCleanOnly()) {
            ...
            processOutput(document.text(), inputRow);
        }
    }
