...
import static ie.dcu.mcm.hop.pipeline.transforms.html2text.Html2TextMeta.SafelistType.basic;
...
public class Html2TextMeta extends BaseTransformMeta<Html2Text, Html2TextData> {
    ...
    public String getXml() {
        return "    " + addTagValue("htmlField", htmlField) +
        ...
        if (input.length > 0) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_OK,
                            getString(
                                    PKG, "Html2TextMeta.CheckResult.ReceivingInfoFromOtherTransforms"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
    ...
    public enum SafelistType {
        ...
        basicWithImages("basicWithImages", getString(PKG, "Html2TextDialog.SafelistType.basicWithImages"));
