...
import static ie.dcu.mcm.hop.pipeline.transforms.llm.chat.internals.Message.toChatMessages;
...
public class LanguageModelFacade {
    ...
    public LanguageModelFacade(IVariables variables, LanguageModelChatMeta meta) {
        ...
        inputJsonAdapter = new Moshi.Builder().build().adapter(newParameterizedType(List.class, Message.class));
        outputJsonAdapter = new Moshi.Builder().build().adapter(newParameterizedType(List.class, BaseMessage.class));
 ...
 */
    ...
    */
    ...
    private ChatLanguageModel createOpenAiModel() {
        ...
        String apiKey = trimToNull(getenv(meta.getOpenAiApiKey()));
...
*/
        ...
        if (meta.isOpenAiUseProxy()) {
            builder.proxy(new Proxy(HTTP, new InetSocketAddress(meta.getOpenAiProxyHost(), meta.getOpenAiProxyPort())));
        }
    ...
    private ChatLanguageModel createHuggingFaceModel() {
        ...
        boolean dedicated = startsWithIgnoreCase(modelResource, "http://") || startsWithIgnoreCase(modelResource, "https://");


        String accessToken = trimToNull(getenv(meta.getHuggingFaceAccessToken()));
    ...
    private ChatLanguageModel createOllamaModel() {
        ...
        boolean url = startsWithIgnoreCase(imageEndpoint, "http://") || startsWithIgnoreCase(imageEndpoint, "https://");
    ...
    private ChatLanguageModel createAnthropicModel() {
        ...
        String apiKey = trimToNull(getenv(meta.getAnthropicApiKey()));
    ...
    private ChatLanguageModel createMistralModel() {
        ...
        String apiKey = trimToNull(getenv(meta.getMistralApiKey()));
    ...
    public String messagesToOutput(List<ChatMessage> chat, String assistant) throws HopValueException {
