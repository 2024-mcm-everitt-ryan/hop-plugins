...
import ie.dcu.mcm.hop.pipeline.transforms.llm.chat.internals.ui.FormDataBuilder.Builder;
...
import static ie.dcu.mcm.hop.pipeline.transforms.llm.chat.internals.ModelType.modelTypeDescriptions;
import static ie.dcu.mcm.hop.pipeline.transforms.llm.chat.internals.ModelType.typeFromDescription;
...
public class GeneralSettingsComposite implements IDialogComposite {
    ...
    public GeneralSettingsComposite(CompositeParameters parameters) {
        ...
        outputFieldNamePrefixInput = new TextVar(parameters.variables(), parameters.parent(), SINGLE | LEFT | BORDER);
        setLook(outputFieldNamePrefixLabel);
        setLook(outputFieldNamePrefixInput);
        layout.control(inputFieldInput);
        outputFieldNamePrefixLabel.setText(i18n("LanguageModelChatDialog.OutputFieldNamePrefixName.Label"));
        ...
        identifierInput = new TextVar(parameters.variables(), parameters.parent(), SINGLE | LEFT | BORDER);
        ...
        parallelismInput = new TextVar(parameters.variables(), parameters.parent(), SINGLE | LEFT | BORDER);
        ...
        mockOutputValueInput = new TextVar(parameters.variables(), parameters.parent(), SINGLE | LEFT | BORDER);
        ...
        modelTypeInput.addSelectionListener(new SelectionAdapter() {
    ...
    public void populateInputs() {
        ...
        mockOutputValueInput.setText(meta.getMockOutputValue() != null ? meta.getMockOutputValue() : "");
        outputFieldNamePrefixInput.setText(meta.getOutputFieldNamePrefix() != null ? meta.getOutputFieldNamePrefix() : "");
    ...
    private void get() {
        if (!gotPreviousFields) {
            try {
                ...
                IRowMeta r = parameters.pipelineMeta().getPrevTransformFields(parameters.variables(), parameters.transformName());
                if (r != null) {
