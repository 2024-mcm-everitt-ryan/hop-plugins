...
import static ie.dcu.mcm.hop.pipeline.transforms.llm.chat.internals.LanguageModelChatModelName.*;
import static ie.dcu.mcm.hop.pipeline.transforms.llm.chat.internals.ModelType.OPEN_AI;
...
@Transform(
        ...
        documentationUrl = "/pipeline/transforms/language-model-chat.html")
public class LanguageModelChatMeta extends BaseTransformMeta<LanguageModelChat, LanguageModelChatData> {
    ...
    public void setDefault() {
        ...
        openAiModelName = OPENAI_GPT_4_TURBO.toString();
        ...
        if (input.length > 0) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_OK,
                            getString(
                                    PKG, "LanguageModelChatMeta.CheckResult.ReceivingInfoFromOtherTransforms"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
